...
<div id="sidebar">
    ...
    <button id="btnReportePedidos" onclick="mostrarBoton('btnReportePedidos')"
        class="btn btn-info" onclick="location.href='reportePedidos.php'">Reporte Pedidos</button>
</div>
...
function mostrarBoton(id) {
    ...
    document.getElementById('btnReportePedidos').style.display = 'block';
    ...
    if(id === 'btnReportePedidos') window.location.href = 'reportePedidos.php';
}
</script>
<!DOCTYPE html>
<html lang="en">
